...
# off or turning off if it's on). For the i-th round, you toggle every i bulb. For the
# n-th round, you only toggle the last bulb. Find how many bulbs are on after n rounds.
#
# Example:
#
# Input: 3
...
# nof can only be odd if it is a perfect square, than the problem simply become counting the number of perfect square till n
