...
class Solution(object):
    ...
    def sortedListToBST_(self, head):
        ...
        # here we get the middle point, even case, like '1234', slow points to '2',
        # '3' is root, '12' belongs to left, '4' is right odd case, like '12345',
        # slow points to '2', '12' belongs to left, '3' is root, '45' belongs to right
