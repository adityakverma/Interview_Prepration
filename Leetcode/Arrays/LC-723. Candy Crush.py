...
# I DID NOT UNDERSTAND BUT ITS HERE ..   <===============================
...
#    Time Complexity: O((R∗C)2)O((R*C)^2)O((R∗C)2), where R,CR, CR,C is the number of rows and columns in board. We need O(R∗C)O(R*C)O(R∗C) to scan the board, and we might crush only 3 candies repeatedly.

#    Space Complexity: O(1)O(1)O(1) additional complexity, as we edit the board in place
